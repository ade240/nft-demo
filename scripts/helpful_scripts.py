...
def get_contact(contract_name):
    """ 
    This function wiill either:
    - Get an address from the config
    - Or deploy a Mock to use for a ntwork that doesn't have the contract 
    ...
    Args:
        ...
        Returns:
            ...
            contract of the type specifie by a dictionary. This could either be a mock
